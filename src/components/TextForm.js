...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}> 
            ...
            <button type="button" className={`btn btn-${props.mode==='light'?'dark':'light'} mx-1`} onClick={handleLowClick}>Convert to Lowercase</button>
            <button type="button" className={`btn btn-${props.mode==='light'?'dark':'light'} mx-1`} onClick={handleClearClick}>Clear Text</button>
            <button type="button" className={`btn btn-${props.mode==='light'?'dark':'light'} mx-1`} onClick={handleCopy}>Copy Text</button>
